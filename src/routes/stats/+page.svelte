				...
				datasets: [
					{
						...
						backgroundColor: Object.keys(stats.creators).map(
							colorChecksum
						),
						hoverOffset: 10,
					},
	...
	<Chart
		...
		config={{
			...
			data: {
				...
				datasets: [
					{
						label: "Bitmaps created",
						data: Object.values(stats.bitmapCreators),
						backgroundColor: Object.keys(stats.bitmapCreators).map(
							colorChecksum
						),
						hoverOffset: 10,
					},
				...
				datasets: [
					{
						...
						backgroundColor: Object.keys(stats.vectorCreators).map(
							colorChecksum
						),
						hoverOffset: 10,
					},
				...
				datasets: [
					{
						...
						backgroundColor: Object.keys(stats.types).map(
							colorChecksum
						),
						hoverOffset: 10,
					},
	...
	<Chart
		...
		config={{
			...
			data: {
				...
				datasets: [
					{
						label: "Fish of category",
						data: Object.values(stats.categories),
						backgroundColor: Object.keys(stats.categories).map(
							colorChecksum
						),
						hoverOffset: 10,
					},
